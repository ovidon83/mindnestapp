  ...
  if (dbThought.share_posts) {
    try {
      ...
      sharePosts = {
        ...
        linkedinImageUrl: posts.linkedinImageUrl,
        linkedinImagePrompt: posts.linkedinImagePrompt,
        instagramImageUrl: posts.instagramImageUrl,
        instagramImagePrompt: posts.instagramImagePrompt,
...
export function thoughtToDbThought(thought: Thought): any {
  ...
  if (thought.sharePosts) {
    dbThought.share_posts = {
      ...
      linkedinImageUrl: thought.sharePosts.linkedinImageUrl,
      linkedinImagePrompt: thought.sharePosts.linkedinImagePrompt,
      instagramImageUrl: thought.sharePosts.instagramImageUrl,
      instagramImagePrompt: thought.sharePosts.instagramImagePrompt,
...
export async function updateThought(id: string, updates: Partial<Thought>): Promise<Thought | null> {
  ...
  if (updates.sharePosts !== undefined) {
    updateData.share_posts = updates.sharePosts ? {
      ...
      linkedinImageUrl: updates.sharePosts.linkedinImageUrl,
      linkedinImagePrompt: updates.sharePosts.linkedinImagePrompt,
      instagramImageUrl: updates.sharePosts.instagramImageUrl,
      instagramImagePrompt: updates.sharePosts.instagramImagePrompt,
