  ...
  if (dbThought.share_posts) {
    try {
      ...
      sharePosts = {
        ...
        // Use shared image if available, otherwise fall back to platform-specific (for backward compatibility)
        imageUrl: posts.imageUrl || posts.linkedinImageUrl || posts.instagramImageUrl,
        imagePrompt: posts.imagePrompt || posts.linkedinImagePrompt || posts.instagramImagePrompt,
...
export function thoughtToDbThought(thought: Thought): any {
  ...
  if (thought.sharePosts) {
    dbThought.share_posts = {
      ...
      imageUrl: thought.sharePosts.imageUrl,
      imagePrompt: thought.sharePosts.imagePrompt,
...
export async function updateThought(id: string, updates: Partial<Thought>): Promise<Thought | null> {
  ...
  if (updates.sharePosts !== undefined) {
    updateData.share_posts = updates.sharePosts ? {
      ...
      imageUrl: updates.sharePosts.imageUrl,
      imagePrompt: updates.sharePosts.imagePrompt,
